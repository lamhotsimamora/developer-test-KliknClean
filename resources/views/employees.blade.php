        ...
        <div id="employees" class="card" v-cloak>
            ...
            <div class="card-body">
                ...
                <div class="input-group mb-3">
                    ...
                    <input ref="search_employees_name" v-model="search_employees_name"
                        @keypress="enterSearchEmployeesName" type="text" class="form-control"
                        placeholder="Employees Name" aria-label="Username" aria-describedby="basic-addon1">
                </div>
                    ...
                    <table class="table table-dark">
                        ...
                        <tbody>
                            <tr v-for="(employees,i) in data_employees">
                                ...
                                <td><button @click="deleteData(employees.employees_id )" type="button"
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="input-group mb-3">
                        ...
                        <input type="text" @keypress="enterSearch" v-model="fullname" placeholder="..."
                            class="form-control" aria-label="Fullname" aria-describedby="basic-addon1" ref="fullname">
                    </div>

                    <select v-model="companies" class="form-select" aria-label="Default select example">
                        <option v-for="companies in data_companies" :value="companies.company_id">
                            @{{ companies . company_name }}</option>
                    </select> <br>

                    <div class="input-group mb-3">
                        <span class="input-group-text" id="basic-addon1">Department</span>
                        <input type="text" @keypress="enterSearch" v-model="department" placeholder="..."
                            class="form-control" aria-label="Department" aria-describedby="basic-addon1"
                            ref="department">
                    </div>
